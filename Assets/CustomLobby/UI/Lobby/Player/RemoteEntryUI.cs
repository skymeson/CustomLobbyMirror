...
namespace UI.Lobby.Player
{
    public class RemoteEntryUI : MonoBehaviour, EntryInterface
    {
        ...
        //// used when PlayerDataForClients changes HMD
        //public void UpdateHMDFromSettings(GameObject player, int hmdtypeID)
        //{
        //    if (hmdtypeID == PlayerDataForClients.HMDTYPE_AR)
        //    {
        //        //hmdText.text = "AR";
        //    }

        //    if (hmdtypeID == PlayerDataForClients.HMDTYPE_OPENVR)
        //    {
        //       //hmdText.text = "VR";
        //    }

        //    if (hmdtypeID == PlayerDataForClients.HMDTYPE_SPECTATOR)
        //    {
        //        //hmdText.text = "Spectator";
        //    }
        //}

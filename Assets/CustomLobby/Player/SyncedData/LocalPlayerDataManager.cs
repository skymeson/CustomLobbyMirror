...
namespace Player.SyncedData {
    public class LocalPlayerDataManager : NetworkBehaviour {
        ...
        public override void OnStartLocalPlayer()
        {
            ...
            clientData.SetHMDType(store.hmdtype);
            ...
            clientData.OnHMDTypeUpdated += OnHmdTypeUpdated;
        ...
        public void OnHmdTypeUpdated(GameObject player, int newHmdType)
        {
            LocalPlayerDataStore.GetInstance().hmdtype = newHmdType;
        }
